...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	zcodeOAuthService := service.NewZcodeOAuthService(proxyRepository)
	zcodeOAuthHandler := admin.NewZcodeOAuthHandler(zcodeOAuthService)
