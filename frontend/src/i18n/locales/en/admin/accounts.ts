export default {
    accounts: {
      ...
      zcode: {
        ...
        apiKeyOptional: 'Optional — OAuth login fills this automatically',
        apiKeyHint: 'Filled automatically by OAuth login, or paste your own z.ai / bigmodel coding plan API key (zai format: {key}.{secret}).',
        jwtRequired: 'Start Plan requires OAuth login to capture the plan JWT first',
        oauth: {
          title: 'ZCode OAuth Login',
          desc: 'Log in with your Z.AI / bigmodel account to auto-create a coding plan API key. Login traffic can go through the selected proxy.',
          start: 'Start Login',
          running: 'Waiting…',
          ...
          waitingPoll: 'Waiting for authorization… this page polls automatically.',
          waitingPaste: 'After authorizing, the browser redirects to 127.0.0.1 (it fails to load) — copy that URL from the address bar and paste it here.',
          success: 'Login succeeded — credentials filled below.',
